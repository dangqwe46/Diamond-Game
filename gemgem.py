...
# NUMGEMIMAGES is the number of gem types (.png image)
# files name is gem0.png, gem1.png, etc. up to gem(N-1).png.
NUMGEMIMAGES = 7
...
def main():
    ...
    # Load the sounds.
    GAMESOUNDS = {}
    GAMESOUNDS['bad swap'] = pygame.mixer.Sound('audio/badswap.wav')
    GAMESOUNDS['match'] = []
    for i in range(NUMMATCHSOUNDS):
        GAMESOUNDS['match'].append(pygame.mixer.Sound('audio/match%s.wav' % i))
    BOARDRECTS = []
